...
namespace JaymeEdwards.PowerDeliveryVSExtension2013
{
    ...
    [ProvideToolWindow(typeof(MyToolWindow), Style = VsDockStyle.MDI, MultiInstances = false)]
    [Guid(GuidList.guidPowerDeliveryVSExtension2013PkgString)]
    public sealed class PowerDeliveryVSExtension2013Package : Package
    {
        /// <summary>
        ...
        /// </summary>
        public PowerDeliveryVSExtension2013Package()
        {
        ...
        protected override void Initialize()
        {
            ...
            if (null != mcs)
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidPowerDeliveryVSExtension2013CmdSet, (int)PkgCmdIDList.cmdidDeploymentPipelines);
