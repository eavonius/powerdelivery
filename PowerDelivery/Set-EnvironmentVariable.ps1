function Set-EnvironmentVariable {
    ...
    foreach ($curComputerName in $computerNames) {
        ...
        Invoke-Command -ComputerName $curComputerName -ErrorAction Stop {
...
"@
		    ...
		    [Environment]::SetEnvironmentVariable($using:name, $using:value, [EnvironmentVariableTarget]::Machine)
